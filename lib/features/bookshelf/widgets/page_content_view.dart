...
class PageContentView extends StatelessWidget {
  ...
  final void Function(int paragraphIndex, ParagraphContent paragraph)? onParagraphLongPress;
  ...
  Widget _buildItem(BuildContext context, ThemeData theme, PageItem item) {
    ...
    final child = _buildContent(theme, item, source);

    if (onParagraphLongPress != null) {
      return GestureDetector(
        onLongPress: () => onParagraphLongPress!(item.paragraphIndex, source),
        child: child,
      );
    }
    return child;
